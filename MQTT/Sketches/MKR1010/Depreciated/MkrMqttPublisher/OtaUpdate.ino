...
/**
 * @brief Called by setup() function to initialize OTA update.
 * 
 */
void handleSketchDownload() {

  nextVersionSD(); // Wait, why is this function only calling another function?
...
/**
 * @brief Downloads the next version of the sketch from the server.
 * 
 */
void nextVersionSD() {
