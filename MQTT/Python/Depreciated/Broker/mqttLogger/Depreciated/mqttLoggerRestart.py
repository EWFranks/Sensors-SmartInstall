...
def generate_post(messageText, topic, timeReceived):
    ...
    reading["reading_val"] = messageParts[0]
...
def check_connection():
    ...
    if time.time() - timeLastMessage > 10:
        print("No messages received in 10 seconds. Restarting connection.")
        client.loop_stop()
        client.disconnect()
...
# Code to handle new file for each day
    while True: # Run forever
        ...
        while( time.time() - startTime < 86400 ): # Continue for 24 hours
            check_connection()
